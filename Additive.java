...
@RequiredParameters(parameters = {"teta"})
public class Additive extends ScoringFunctionIterator
  ...
  private final double collectionL;
  private final double background;

  public Additive(NodeParameters p, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(p, ls, it);
  ...
  private double dirichletScore(double count, double length) {
    double numerator = count + teta;
    double denominator = length + collectionL;
